...
export const MainPage = () => {
  ...
  return (
    <div className="w-full min-h-[720px] max-h-[720px] flex items-center justify-center bg-[#fcfbfb]">
      <div className="max-w-[1440px] w-full h-[720px] flex items-center justify-center relative">
        ...
        <div className="absolute top-0 hidden sm:flex flex-col items-center justify-center gap-2">
          <h1 className="text-[30px] font-fenix text-[#7c02c4e6]">SHINE</h1>
          <h1 className="text-[20px] font-fenix text-[#7c02c4e6]">
            BEAUTY CLINIC
          </h1>
          <div className="flex gap-5">
            <div className="w-[30px] h-[30px] bg-purple rounded-md flex items-center justify-center cursor-pointer">
              <svg
        ...
        <Image
          ...
          height={700}
        />
        <div className="absolute bottom-14 hidden sm:flex flex-col items-center justify-center gap-2">
